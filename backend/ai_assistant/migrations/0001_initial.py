    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(default='google/gemini-flash-1.5-8b', max_length=100, verbose_name='Модель')),
                ('base_url', models.CharField(default='https://openrouter.ai/api/v1', max_length=255, verbose_name='Базовый URL')),
